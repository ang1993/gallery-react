        ...
        <div className="myCol">
          <header className="welcomeUserHeader">
            ...
            <p>
              ...
              in enim nisl. Suspendisse mauris tortor, consectetur ut ipsum a,
              euismod fermentum velit. Donec quis felis et ligula ornare auctor.{" "}
            </p>
          </header>
          ...
          <div className="buttonsBox">
            ...
            <Link className="ScndButton" onClick={logOut}>
              Logout
            </Link>
          </div>
        </div>
